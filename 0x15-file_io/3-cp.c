...
/**
 * close_errchk - closess a file descriptor and prints
 ...
 * @fd2: second descriptor to close @filename prompting the error
 ...
 * @filename: filename prompting the erroe
 * Return: 98
 */
...
int main(int ac, char *av[])
{
	...
	file_from = open(av[1], O_WRONLY | O_CREAT | O_TRUNC,
